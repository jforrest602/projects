...
To create the visualization, navigate to the hamburger menu, `Dashboards > Create dashboard > Create visualization`. Once there, paste in the custom search parameters and format to suit your specific needs. In this case, `winlog.event_data.Image`, `winlog.event_data.DestinationIp`, `winlog.event_data.SourceIp`, `winlog.event_data.DestinationPort` will provide what is needed here.
